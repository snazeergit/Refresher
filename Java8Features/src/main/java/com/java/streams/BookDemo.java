...
public class BookDemo {
	...
	public static void main(String[] args) {
		List<Book> books = Arrays.asList(new Book("The Fellowship of the Ring", "J.R.R. Tolkien", 1954, 30),
				new Book("The Hobbit", "J.R.R. Tolkien", 1937, 40), new Book("Animal Farm", "George Orwell", 1945, 32),
